...
private[vsts] case class Property[A](`type`: String, value: A)
private[vsts] case class Properties(supportsMarkDown: Property[Int], uniqueId: Property[String])
private[vsts] case class Comment(commentType: Int, content: String)
private[vsts] case class CreateThreadRequest(id: Int = -1,
...
private[vsts] object CreateThreadRequest {
